...
public class LeaveManagerTest {
    ...
    public LeaveManagerTest() {
        ...
        this.request = new LeaveRequest(employee, null, null,LeaveType.GENERAL);
...
//    }
    ...
    @Test
    void testIfTheLeaveBalanceIsPositive() {
        setRequest(new LeaveRequest(employee, today(), after4Days(),LeaveType.GENERAL));
        assertEquals(leaveResponse.leaveResponses.toString(),leaveResponse.leaveStatus,LeaveStatus.ACCEPTED);
    }

    @Test
    void testIfTheLeaveBalanceIsNotPositive() {
